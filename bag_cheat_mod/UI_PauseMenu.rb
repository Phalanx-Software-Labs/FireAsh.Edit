#===============================================================================
# Pause menu — Pokémon Fire Ash 3.6 base + "Mods" (bag quantity cheat).
#===============================================================================
...
class PokemonPauseMenu
  ...
  def pbStartPokemonMenu
    ...
    commands[cmdBag = commands.length]       = _INTL("Bag") if !pbInBugContest? && !$game_switches[675]
    ...
    commands[cmdMods = commands.length]      = _INTL("Mods")
